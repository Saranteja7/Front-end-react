    ...
    render() {
        return (
            <div className="container login-container">
                <h1 className="text-monospace heading-leaderboard">Login</h1>
                <form onSubmit={this.handleLogin}>
                    ...
                    <div className="form-group group-edit">
                        <input type="password" required name="password" placeholder="Password" onChange={this.changeFormData} className="form-control login-form-input" />
                        <font className={`error-data ${this.state.display2}`}>Invalid password!</font>
                    </div>
                    <div className="form-group">
                        <button className="form-control btn btn-success login-button-edit" >Login</button>
                    </div>
                    <div>
